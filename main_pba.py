...
cogs_seeds_nutrients, nutrient_consumption, total_no_of_plants = calc_nutrients_and_num_plants(scenario, weight_adjusted_yields)
avg_photoperiod = calc_avg_photoperiod(scenario)


scenario.electricity_price = pba.norm(0.06, 0.01)
# scenario.electricity_pricing = 0.06
#print(scenario.electricity_pricing)
...
#print(cogs_electricity)

#cogs_electricity = pnt(cogs_electricity)
